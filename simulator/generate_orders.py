...
BOOTSTRAP_SERVERS = 'ecommerce-namespacee.servicebus.windows.net:9093'
EVENT_HUB_CONNECTION_STRING = 'Endpoint=sb://ecommerce-namespacee.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=3dACFKl5IwhGimA5h+eV/B59Qdr/c1OS++AEhKVH39w='
